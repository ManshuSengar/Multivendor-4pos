    ...
    return (
        <footer className='bg-[#F3F6Fa]'>
            <div className='w-[85%] flex flex-wrap mx-auto border-b py-16 md-lg:pb-10 sm:pb-6'>
                <div className='w-3/12 lg:w-4/12 sm:w-full'>
                    <div className='flex flex-col gap-3'>
                        <img className='w-[190px] h-[70x]' src="http://142.93.71.196:3000/images/logo.png" alt="logo" />
                        <ul className='flex flex-col gap-2 text-slate-600'>
                            <li>Address : Lucknow , India</li>
                            <li>Phone : +91 9569555922</li>
                            <li>Email : sourabhshail@gmail.com</li>
                        </ul>
                    </div>
                </div>
            ...
            <div className='w-[85%] flex flex-wrap justify-center items-center text-slate-600 mx-auto py-5 text-center'>
                <span>Copiright ©2024 All rights reserved | mady by <a className='text-blue-500 underline' href="">@Sourabh</a></span>
            </div>
