        ...
        <div className='bg-white p-5'>
            ...
            <div className='grid grid-cols-2 gap-3'>
                ...
                <div className='text-slate-600'>
                    ...
                    <p>Payment status: <span className={`py-[1px] text-xs px-3 ${myOrder.payment_status === 'paid' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'} rounded-md`}>{myOrder.payment_status}</span></p>
                                    ...
                                    <div className='flex gap-2'>
                                        ...
                                        <div className='flex text-sm flex-col justify-start items-start'>
                                            ...
                                            {p.addons && p.addons.length > 0 && (
                                                <div className="mt-2">
                                                    <p className="text-sm font-medium text-gray-500">Addons:</p>
