    ...
    get_card_products = async (req, res) => {
        ...
        try {
            ...
            for (let i = 0; i < stockProduct.length; i++) {
                const { quantity, price } = stockProduct[i]
                        ...
                        p[i] = {
                            ...
                            products: p[i] ? [
                                ...p[i].products,
                                {
                                    ...
                                    price: stockProduct[j].price,
                                    addons: stockProduct[j].addons || [], // Include selected addons from cardModel
                                    productInfo: {
                                        _id: tempProduct._id,
