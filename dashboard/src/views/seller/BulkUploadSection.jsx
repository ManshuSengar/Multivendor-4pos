...
const BulkUploadSection = ({ bulkPricing, setBulkPricing, errors }) => {
  ...
  const removeBulkPricing = (index) => {
    ...
    console.log(updatedBulkPricing);
  ...
  return (
    <div className="mb-4">
      <h2 className="text-xl font-semibold mb-2 text-[#d0d2d6]">Bulk Discount Pricing</h2>
        ...
        <div key={index} className="flex items-center mb-2">
          <div className="flex-1 mr-2">
            <input
              ...
              className="w-full px-3 py-2 bg-[#283046] border border-slate-700 rounded-md text-[#d0d2d6]"
            />
