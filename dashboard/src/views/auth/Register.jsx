                ...
                <div className='bg-[#283046] p-4 rounded-md'>
                    ...
                    <form onSubmit={submit}>
                        <div className='flex flex-col w-full gap-1 mb-3'>
                            ...
                            <input onChange={inputHandle} value={state.name} className='px-3 py-2 outline-none border border-slate-700 bg-transparent rounded-md text-[#d0d2d6] focus:border-indigo-500 overflow-hidden' type="text" name='name' placeholder='name' id='name'  />
                            {errors.name && <span className="text-red-500">{errors.name}</span>}
                        </div>
                        <div className='flex flex-col w-full gap-1 mb-3'>
                            <label htmlFor="email">Email</label>
                            <input onChange={inputHandle} value={state.email} className='px-3 py-2 outline-none border border-slate-700 bg-transparent rounded-md text-[#d0d2d6] focus:border-indigo-500 overflow-hidden' type="email" name='email' placeholder='email' id='email'  />
                            {errors.email && <span className="text-red-500">{errors.email}</span>}
                        </div>
                        <div className='flex flex-col w-full gap-1 mb-3'>
                            <label htmlFor="password">Password</label>
                            <input onChange={inputHandle} value={state.password} className='px-3 py-2 outline-none border border-slate-700 bg-transparent rounded-md text-[#d0d2d6] focus:border-indigo-500 overflow-hidden' type="password" name='password' placeholder='password' id='password'  />
                            {errors.password && <span className="text-red-500">{errors.password}</span>}
                        </div>
                        <div className='flex flex-col w-full gap-1 mb-3'>
                            <label htmlFor="countryId">Country</label>
                            <select onChange={inputHandle} value={state.countryId} className='px-3 py-2 outline-none border border-slate-700 bg-[#283046] rounded-md text-[#d0d2d6] focus:border-indigo-500 overflow-hidden' name='countryId' id='countryId' >
                        ...
                        <div className='flex flex-col w-full gap-1 mb-3'>
                            ...
                            <select onChange={inputHandle} value={state.currencyId} className='px-3 py-2 outline-none border border-slate-700 bg-[#283046] rounded-md text-[#d0d2d6] focus:border-indigo-500 overflow-hidden' name='currencyId' id='currencyId' >
